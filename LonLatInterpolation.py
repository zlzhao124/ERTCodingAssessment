...
#add lons, lats, and values to lists
...
#i use the linear interprolation from scipy.interpolate here
interp_func = interp2d(lons, lats, values, kind='linear')

#makes a grid of evenly spaced lats and lons given the range you want
gridlons = np.linspace(121, 131, 50)
gridlats = np.linspace(10, 16, 70)

#evaluates interpolated values at each grid point
interpolated_values = interp_func(gridlons, gridlats)
print(interpolated_values)

#creates plot of interpolated values
